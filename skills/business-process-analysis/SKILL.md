...
If materially different process scopes remain unresolved after retrieval, use `clarifying-interview`. Do not ask for facts that retrieval can establish.
...
- `clarifying-interview` resolves material ambiguity and user decisions.
