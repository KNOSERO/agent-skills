...
- If a material change outside approved scope is required, stop the dependent work, explain why, and request expanded approval; use `grill` for an unresolved material decision.
